        ...
        <div className={Styles.quizContainer}>
          ...
          <Link key={quiz.id} href={quiz.link} className={Styles.quizCard}>
            <div className={Styles.cardHeader}>
              <div className={Styles.folder} style={{background: quiz.colorBg}}><FaRegFolder style={{color: quiz.colorIcon}}/></div>
            ...
            <div className={Styles.quizInfo}>
              ...
              <span className={Styles.quizCount}><FaRegClock/> {quiz.quizConts} Perguntas</span>
            </div>
          </Link>
        ))}
        </div>
